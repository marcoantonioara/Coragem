...
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_CALIB_MODE_CONFIG                       2                                                                                                // set by application[NRF52840_DK]
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_CALIB_TIMER_INTERVAL                    16                                                                                               // set by application[NRF52840_DK]
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_SRC                                     NRF_LF_SRC_RC                                                                                    // set by application[NRF52840_DK]
...
#define MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE                           9600                                                                                             // set by application[NRF52840_DK]
...
#define MBED_CONF_PLATFORM_STDIO_BAUD_RATE                                    9600                                                                                             // set by application[NRF52840_DK]
